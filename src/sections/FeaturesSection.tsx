    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI-powered thumbnail generator is designed to help you create eye-catching thumbnails that drive clicks and engagement. With our smart analysis, you can generate vibrant, high-contrast designs that are fully customizable to match your brand and content. Say goodbye to boring thumbnails and hello to increased click-through rates with our easy-to-use tool.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your views with AI-powered design</h3>
                        <p className="text-slate-300 mt-2">Stop guessing and start ranking. Our AI creates designs proven to capture attention and increase click-through rates.</p>
